    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">Reportes <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a href="<?php echo $helper->url("Reporte", "ingresoFechas"); ?>">Ganancia por fechas</a></li>
                  <li><a href="<?php echo $helper->url("Reporte", "ingresoCabania"); ?>">Ganancia por Cabaña</a></li>
