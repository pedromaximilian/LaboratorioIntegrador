...
class Propietario extends EntidadBase
{
    ...
    public function guardaPass()
    {
            ...
            $query = "UPDATE propietario set codigo = NULL, pass = '".$this->pass."' where id = ".$this->id.";";
            $save=$this->db()->query($query);
            
        
    }

    public function guardaCodigo($codigo)
    {

            $query = "UPDATE propietario set codigo = '".$codigo."' where id = ".$this->id.";";
            $save=$this->db()->query($query);
            //return var_dump("Guardo el codigo". $save);
