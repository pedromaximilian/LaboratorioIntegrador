...
class Reserva extends  EntidadBase
{
    ...
    public function reservasPorCavania($id){

        
        $resultSet = null;

        $query=$this->db()->query("SELECT * FROM reserva WHERE idCabania = $id");
    ...
    public function reservasPorFechas($inicio, $fin){

        
        $resultSet = null;

        $query=$this->db()->query("SELECT * FROM reserva WHERE inicio >= '$inicio' AND fin <= '$fin'");
