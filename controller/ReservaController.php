...
class ReservaController extends ControladorBase
{
    ...
    */
    ...
    public function reservasPorCabania()
    {
        
        if (isset($_GET["id"])) {

            $reserva = new Reserva($this->adapter);
            $lista = $reserva->reservasPorCavania((int) $_GET["id"]);

            if (isset($lista)) {
                //Cargamos la vista index y le pasamos valores
            $this->view("Reserva/reservasPorCabania", array(
                "lista" => $lista
            ));
            }else{
            ...
            $this->view("Cabania/index", array(
                "lista" => $lista,
                "error" => "no hay reservas para esta cabania"
            ));
            }
    ...
    public function misReservasPorCabania()
    {

        //return var_dump("buscando cabanias");
        ...
        if (isset($_GET["id"])) {
            ...
            if (isset($lista)) {
                //Cargamos la vista index y le pasamos valores
            $this->view("Inicio/misReservasPorCabania", array(
                "lista" => $lista
            ));
            }else{
                $cab = new Cabania($this->adapter);
